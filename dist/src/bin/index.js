...
try {
    ...
    if (subcommand === 'init') {
        await writeFile(`${rootDir}/.eslintrc.cjs`, `module.exports = {
    env: {
        es2024: true,
        node: true,
    },
    ...
    plugins: ['@typescript-eslint'],
        ...
        await writeFile(`${rootDir}/tsconfig.json`, JSON.stringify({
        ...
        await writeFile(`${rootDir}/.prettierrc.json`, JSON.stringify({
            trailingComma: 'es5',
            tabWidth: 4,
            semi: false,
            singleQuote: true
